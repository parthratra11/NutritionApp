...
export default function SleepScreen() {
  ...
  const sleepTableData = [
    { date: "22 July 2025", quality: "Light", sleepTime: "10:30 PM", wakeTime: "6:30 AM", duration: "8h 0m" },
    { date: "23 July 2025", quality: "Deep", sleepTime: "11:00 PM", wakeTime: "7:00 AM", duration: "8h 0m" },
    { date: "24 July 2025", quality: "Interrupted", sleepTime: "11:30 PM", wakeTime: "7:30 AM", duration: "8h 0m" },
    { date: "25 July 2025", quality: "Awake", sleepTime: "10:30 PM", wakeTime: "6:30 AM", duration: "8h 0m" },
    { date: "26 July 2025", quality: "Deep", sleepTime: "11:00 PM", wakeTime: "7:00 AM", duration: "8h 0m" },
    { date: "27 July 2025", quality: "Light", sleepTime: "10:00 PM", wakeTime: "6:00 AM", duration: "8h 0m" },
    { date: "28 July 2025", quality: "Interrupted", sleepTime: "9:00 PM", wakeTime: "7:00 AM", duration: "10h 0m" },
  ];
            ...
            <div className="bg-[#142437] border border-[#22364F] rounded-lg p-5">
              <div className="flex justify-between items-center mb-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-2 bg-[#E7AB4A] text-xs rounded-md px-2 py-0.5">Mildly Inconsistent</div>
                </div>
              ...
              <div className="h-[300px] relative">
                ...
                <div className="pl-12 h-full flex justify-between">
                  {sleepScheduleData.map((day, index) => {
                    ...
                    const height = ((day.sleepEnd + 24 - day.sleepStart) / 18) * 100; // Height based on sleep duration
                    
                    return (
                      <div key={index} className="flex flex-col items-center flex-1">
                        <div className="relative h-full w-full flex justify-center">
                          <div 
                            className={`w-8 absolute rounded-lg ${day.highlight ? 'bg-[#DD3333]' : 'bg-gray-600'}`}
                            style={{
                              top: `${top}%`,
                              height: `${height}%`,
                            }}
