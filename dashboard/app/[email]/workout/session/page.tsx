  ...
  const getProgressOutline = (
    ...
    if (
      ...
      if (currentTotalVolume > previousTotalVolume) {
        ...
        return "border-4 border-blue-500"; // No progress = red
      }
    }
  ...
  const getProgressArrow = (
    ...
    if (
      ...
      if (currentTotalVolume > previousTotalVolume) {
        ...
        return (
          <div className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center absolute -top-4 -right-4 z-[5]">
            {/* <svg
              className="w-5 h-5 text-white"
              fill="currentColor"
              viewBox="0 0 24 24"
