...
import { ScrollView, View, Text, TextInput, Button, KeyboardAvoidingView, Platform, TouchableOpacity } from 'react-native';
  ...
  return (
    ...
    >
      ...
      >
        ...
        <TextInput style={styles.input} onChangeText={t => handleChange('fullName', t)} value={form.fullName} />

        <Text style={styles.label}>Street and house number</Text>
        <TextInput style={styles.input} onChangeText={t => handleChange('street', t)} value={form.street} />

        <Text style={styles.label}>Postal code</Text>
        <TextInput style={styles.input} onChangeText={t => handleChange('postalCode', t)} value={form.postalCode} />

        <Text style={styles.label}>City*</Text>
        <TextInput style={styles.input} onChangeText={t => handleChange('city', t)} value={form.city} />

        <Text style={styles.label}>Country*</Text>
        <TextInput style={styles.input} onChangeText={t => handleChange('country', t)} value={form.country} />

        <Text style={styles.label}>Age*</Text>
        <TextInput style={styles.input} onChangeText={t => handleChange('age', t)} value={form.age} keyboardType="numeric" />

        <Text style={styles.label}>Height*</Text>
        <TextInput style={styles.input} onChangeText={t => handleChange('height', t)} value={form.height} />

        <Text style={styles.label}>Weight*</Text>
        <TextInput style={styles.input} onChangeText={t => handleChange('weight', t)} value={form.weight} />

        <Text style={styles.label}>Body fat percentage (plus estimation method)</Text>
        <TextInput style={styles.input} onChangeText={t => handleChange('bodyFat', t)} value={form.bodyFat} />

        <Text style={styles.label}>Do you have experience with strength training?</Text>
        <TextInput style={styles.input} onChangeText={t => handleChange('strengthTrainingExperience', t)} value={form.strengthTrainingExperience} />

        {/* STRENGTH LEVEL */}
        <Text style={styles.sectionTitle}>2. Strength Level</Text>
        <Text style={styles.label}>Barbell Bench Press (kg x reps)</Text>
        <TextInput style={styles.input} onChangeText={t => handleChange('benchPress', t)} value={form.benchPress} />

        <Text style={styles.label}>Back Squat (kg x reps)</Text>
        <TextInput style={styles.input} onChangeText={t => handleChange('squat', t)} value={form.squat} />

        <Text style={styles.label}>Chin-up (kg x reps)</Text>
        <TextInput style={styles.input} onChangeText={t => handleChange('chinUp', t)} value={form.chinUp} />

        <Text style={styles.label}>Deadlift (kg x reps)</Text>
        <TextInput style={styles.input} onChangeText={t => handleChange('deadlift', t)} value={form.deadlift} />

        <Text style={styles.label}>Barbell Overhead Press (kg x reps)</Text>
        <TextInput style={styles.input} onChangeText={t => handleChange('overheadPress', t)} value={form.overheadPress} />

        <Text style={styles.label}>How would you rate your competency on the aforementioned exercises?*</Text>
        <TextInput style={styles.input} onChangeText={t => handleChange('exerciseCompetency', t)} value={form.exerciseCompetency} />

        {/* GOALS */}
        <Text style={styles.sectionTitle}>3. Goals</Text>
        <Text style={styles.label}>What are your top 3 goals?*</Text>
        <TextInput multiline style={styles.input} onChangeText={t => handleChange('goals', t)} value={form.goals} />

        <Text style={styles.label}>What is your number 1 obstacle?*</Text>
        <TextInput style={styles.input} onChangeText={t => handleChange('obstacle', t)} value={form.obstacle} />

        <Text style={styles.label}>Will you be performing any other form of exercise alongside strength training?*</Text>
        <TextInput style={styles.input} onChangeText={t => handleChange('otherExercises', t)} value={form.otherExercises} />
        ...
        <View style={{ marginTop: 10 }}>
          ...
          >
            <View style={[styles.checkbox, form.dedicationLevel === 'A' && styles.checkboxChecked]} />
            <Text style={{ flex: 1 }}>
          ...
          >
            <View style={[styles.checkbox, form.dedicationLevel === 'B' && styles.checkboxChecked]} />
            <Text style={{ flex: 1 }}>
          ...
          >
            <View style={[styles.checkbox, form.dedicationLevel === 'C' && styles.checkboxChecked]} />
            <Text style={{ flex: 1 }}>
        ...
        <TextInput style={styles.input} onChangeText={t => handleChange('weeklyFrequency', t)} value={form.weeklyFrequency} />

        {/* Misc */}
        <Text style={styles.label}>What is your occupation?</Text>
        <TextInput style={styles.input} onChangeText={t => handleChange('occupation', t)} value={form.occupation} />

        <Text style={styles.label}>Please list any medical conditions or injuries</Text>
        <TextInput multiline style={styles.input} onChangeText={t => handleChange('medicalConditions', t)} value={form.medicalConditions} />

        <Text style={styles.label}>Do you currently follow any special diet?</Text>
        <TextInput style={styles.input} onChangeText={t => handleChange('specialDiet', t)} value={form.specialDiet} />

        {/* Lifestyle */}
        <Text style={styles.label}>Training time preference*</Text>
        <TextInput multiline style={styles.input} onChangeText={t => handleChange('trainingTimePreference', t)} value={form.trainingTimePreference} />

        {/* Activity Level */}
        <Text style={styles.label}>Which of the following options best describes your activity level (this does NOT include exercise)?*</Text>
        <View style={{ marginTop: 10 }}>
          <TouchableOpacity
            style={[styles.checkboxContainer, { alignItems: 'flex-start', marginBottom: 10 }]}
            onPress={() => handleChange('activityLevel', 'Sedentary')}
          >
            <View style={[styles.checkbox, form.activityLevel === 'Sedentary' && styles.checkboxChecked]} />
            <Text style={{ flex: 1 }}>
          ...
          >
            <View style={[styles.checkbox, form.activityLevel === 'Somewhat active' && styles.checkboxChecked]} />
            <Text style={{ flex: 1 }}>
          ...
          >
            <View style={[styles.checkbox, form.activityLevel === 'Active' && styles.checkboxChecked]} />
            <Text style={{ flex: 1 }}>
          ...
          >
            <View style={[styles.checkbox, form.activityLevel === 'Very active' && styles.checkboxChecked]} />
            <Text style={{ flex: 1 }}>
        ...
        {/* Stress Level */}
        <Text style={styles.label}>Which of the following options best describes your stress level?*</Text>
        <View style={{ marginTop: 10 }}>
          <TouchableOpacity
            style={[styles.checkboxContainer, { alignItems: 'flex-start', marginBottom: 10 }]}
            onPress={() => handleChange('stressLevel', 'Stress-free')}
          >
            <View style={[styles.checkbox, form.stressLevel === 'Stress-free' && styles.checkboxChecked]} />
            <Text style={{ flex: 1 }}>
          ...
          >
            <View style={[styles.checkbox, form.stressLevel === 'Only occasional/mild stress' && styles.checkboxChecked]} />
            <Text style={{ flex: 1 }}>
          ...
          >
            <View style={[styles.checkbox, form.stressLevel === 'Average stress' && styles.checkboxChecked]} />
            <Text style={{ flex: 1 }}>
          ...
          >
            <View style={[styles.checkbox, form.stressLevel === 'High stress' && styles.checkboxChecked]} />
            <Text style={{ flex: 1 }}>
        ...
        <TextInput style={styles.input} onChangeText={t => handleChange('sleepQuality', t)} value={form.sleepQuality} />

        <Text style={styles.label}>Caffeine Intake (Daily Avg)</Text>
        <TextInput style={styles.input} onChangeText={t => handleChange('caffeineIntake', t)} value={form.caffeineIntake} />

        <Text style={styles.label}>[Women only] Menstrual Cycle & Contraception</Text>
        <TextInput multiline style={styles.input} onChangeText={t => handleChange('menstrualCycle', t)} value={form.menstrualCycle} />
        ...
        <TextInput multiline style={styles.input} onChangeText={t => handleChange('supplements', t)} value={form.supplements} />

        {/* Genetics */}
        <Text style={styles.label}>Wrist circumference (smallest point)</Text>
        <TextInput style={styles.input} onChangeText={t => handleChange('wristCircumference', t)} value={form.wristCircumference} />

        <Text style={styles.label}>Ankle circumference (smallest point)</Text>
        <TextInput style={styles.input} onChangeText={t => handleChange('ankleCircumference', t)} value={form.ankleCircumference} />

        {/* Current Program */}
        <Text style={styles.label}>Describe a typical day of eating (or diet plan)</Text>
        <TextInput multiline style={styles.input} onChangeText={t => handleChange('typicalDiet', t)} value={form.typicalDiet} />

        <Text style={styles.label}>Describe or attach your current training program</Text>
        <TextInput multiline style={styles.input} onChangeText={t => handleChange('currentTraining', t)} value={form.currentTraining} />
